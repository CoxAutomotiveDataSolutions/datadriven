...
d3.csv("{{ '/datasets/morley.csv' | relative_url }}", function(error, csv) {
  var data = [];
...
This guide was taken from here: [http://dan-cole.com/2017/d3js-example/](http://dan-cole.com/2017/d3js-example/).
{: .notice--info}
